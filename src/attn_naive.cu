...
int main() {
    ...
    int d_k = 8;
    int d_v = 8;
    int block_size = 32; // Block size for quantization

    printf("=== Starting Test: Naive Attention with Quantization ===");
    ...
    printf("Speedup: %.2fx\n", elapsed_time_unquant / elapsed_time_quant);
    printf("\n");
